...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>shibbir-it</title>
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link rel="apple-touch-icon" href="{{asset('site/portfolio/apple-touch-icon.png ')}}">

        <!--Google Fonts link-->
        <link href="https://fonts.googleapis.com/css?family=SMyce+Sans+Pro:300,300i,400,400i,600,600i,700,700i" rel="stylesheet">
        <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,400i,600,600i,700,700i" rel="stylesheet">


        <link rel="stylesheet" href="{{asset('site/portfolio/css/iconfont.css ')}} ">
        <link rel="stylesheet" href="{{asset('site/portfolio/css/slick/slick.css ')}} ">
        <link rel="stylesheet" href="{{asset('site/portfolio/css/css/slick/slick-theme.css ')}}">
        <link rel="stylesheet" href="{{asset('site/portfolio/css/font-awesome.min.css ')}} ">
        <link rel="stylesheet" href="{{asset('site/portfolio/css/jquery.fancybox.css ')}} ">
        ...
        <!--Theme cMEtom css -->
        <link rel="stylesheet" href="{{asset('site/portfolio/css/style.css ')}} "/>
    ...
    <body data-spy="scroll" data-target=".navbar-collapse">
                        ...
                        <div class="main_service">
                            ...
                            <div class="col-md-6 col-sm-12 no-padding">
                                <figure class="single_service single_service_img">
                                    ...
                                    <img src="{{asset('site/portfolio/images/servicerightimg.jpg ')}}" alt="" />
                                </figure><!-- End of figure -->
                            </div><!-- End of col-sm-6 -->
                                ...
                                <div class="single_study_right_img">
                                    <div class="col-sm-6">
                                        <div class="single_study_img">
                                            <img src="{{asset('site/portfolio/images/study.jpg ')}}" alt="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <script src="{{asset('site/portfolio/js/vendor/jquery-1.11.2.min.js ') }}  "></script>
     
        <script src="{{asset('site/portfolio/js/vendor/bootstrap.min.js ') }} "></script>

        <script src="{{asset('site/portfolio/js/jquery.magnific-popup.js ') }}"></script>
        <script src="{{asset('site/portfolio/js/jquery.mixitup.min.js ') }} "></script>
        <script src="{{asset('site/portfolio/js/jquery.easing.1.3.js ') }} "></script>
        <script src="{{asset('site/portfolio/js/jquery.masonry.min.js ') }} "></script>

        <!--slick slide js -->
        <script src="{{asset('site/portfolio/css/slick/slick.js ')}} "></script>
        <script src="{{asset('site/portfolio/css/slick/slick.min.js ')}} "></script>
