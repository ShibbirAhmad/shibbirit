...
<div style="overflow:hidden;align:center" class="slider"><h2 style="color:#fff;margin:100px;margin-left:500px;" class="heading">{{$posts->count() }} posts found for {{ $searchQuery }} </h2></div>
@endsection
